...
export const NoteCard: React.FC<NoteCardProps> = ({ 
  ...
  return (
    <div
      ...
      className="aspect-[3.8/5] rounded-[14px] p-5 flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 cursor-pointer group relative overflow-hidden"
    ...
    >
      ...
      <div>
        ...
        <h3 className="font-serif text-[22px] text-stone-900 leading-[1.15] mb-1.5 line-clamp-3">
          {note.title}
        </h3>
        
        {preview && (
          <p className="text-[13px] text-stone-500 line-clamp-2">
            {preview}
          </p>
        )}
      </div>
