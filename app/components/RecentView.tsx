  ...
  return (
    <div className="h-full overflow-y-auto bg-white">
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 md:py-8 lg:py-12">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Recent</h1>
        ...
        {recentNotes.length === 0 && (
          <div className="text-center py-12 text-stone-500">
            <p className="text-sm md:text-base">No recent notes. Open a note to see it here.</p>
          </div>
        )}
      </div>
